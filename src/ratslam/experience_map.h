 ...
 * openRatSLAM
 *
 * experience_map - Defines the undirected graph (experience map) for RatSLAM.
 *
 * Copyright (C) 2012
...
/**
 * @file experience_map.h
 * @brief Defines the Experience_Map class and related structures for RatSLAM.
 */
...
/**
 * @struct Link
 * @brief Represents a link (edge) between two experiences in the experience map.
 */
  struct Link
  {
    double d;           ///< Distance between experiences
    double heading_rad; ///< Heading angle in radians
    double facing_rad;  ///< Facing angle in radians
    int exp_to_id;      ///< ID of the destination experience
    int exp_from_id;    ///< ID of the source experience
    double delta_time_s; ///< Time difference between experiences
...
/**
 * @struct Experience
 * @brief Represents a node (experience) in the experience map.
 */
  struct Experience
  {
    int id; // its own id
